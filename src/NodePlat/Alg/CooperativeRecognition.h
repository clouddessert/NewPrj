...
//********  输入：主舰统计的航迹数、ESM数、COM数，即总决策数                ****************//
//********        主舰自身的侦察识别信息（当前时间）                              **********//
//********        各邻舰解包后的各ESM、COM、航迹信息                              **********//
//********        识别结果整理数组                                                **********//
...
//void GET_Cooperate_ReCognition_Modul(SHIP_POSITION& stSelfPosi,VCT_Request_Cooperative_Msg& vctRequestCooperative, VCT_BACK_Cooperative_Msg& vctBackCooperative, );
